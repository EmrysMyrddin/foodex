            ...
            <FoodexCard
                cover={
                    <div className="label">
                        ...
                        item.ingredients.filter(i => i.ingredient.category.diet_category?.diet.name === 'carnivorous').length > 0 ||
                ...
                description={
                    item.tag_recipes.length > 0 && <div>
                        {item.tag_recipes.map(tag => <Tag key={tag.tag.id} color="magenta">{tag.tag.name}</Tag>)}
                    </div>
                }
            />
        </>
