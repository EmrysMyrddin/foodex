...
import {Spin, Card, Button, Modal, Input, Form} from 'antd'
        ...
        <div className="container-details">
            ...
            <div className="info-details">
                ...
                <div className="recipe">
                    <article dangerouslySetInnerHTML={{__html: marked.parse(data.recipe_by_pk.description)}}/>
                </div>
            </div>
    
            <div className="add"><Button  onClick={() => setEditing(true)} type="primary" size="large" shape="circle" icon={<EditOutlined />} /></div>
            <RecipFormModal
              title="Modifier la recette" visible={editing}
              ...
              loading={resultUpdate.fetching} initialValues={data.recipe_by_pk} />
        </div>
    )
}
